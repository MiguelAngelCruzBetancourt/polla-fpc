...
// Lee outboxEvents/matches/predictions/rooms de solo lectura (propiedad de
// business-api) para armar destinatarios, y es dueño exclusivo de escritura
// de notificationDevices/notificationLog. Ver principio "single writer por
// colección" del plan de migración.
